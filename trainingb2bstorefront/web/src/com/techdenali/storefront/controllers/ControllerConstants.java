 ...
 */
package com.techdenali.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Guest
			{
				...
				String GuestReqQuotePage = "pages/guest/guestReqQuotePage";
			}
		...
		interface Fragments
		{
			interface Cart
			{
				...
				String GuestReqQuotePopup = "fragments/cart/GuestReqQuotePopup";
			...
			{
				//String GuestReqQuotePopUp = "fragments/cart/guestReqQuotePopup";
				String GuestQuoteFormPopup = "fragments/guest/GuestForm";
			}
			interface Account
			{
