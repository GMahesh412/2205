...
public class DefaultCustomPromotionService implements CustomPromotionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomPromotionService.class);
	...
	{
		return DefaultCustomPromotionService.class.getResourceAsStream("/CustomPromotion/sap-hybris-platform.png");
	}
